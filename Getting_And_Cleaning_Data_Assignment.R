...
## ----------- This part of the code is used once to download the data --------
## Download the data
fileURL <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
if (!file.exists("DataWeek4")) {dir.create("DataWeek4")}
setwd("~/DataWeek4")
download.file(fileURL,"DataWeek4.zip")
unzip("DataWeek4.zip")

## ----------- This part of the code is the answer to point #1 -------------

## Find variable names
setwd("C:/Users/Lenovo/Documents/DataWeek4/UCI HAR Dataset")
...
setwd("C:/Users/Lenovo/Documents/DataWeek4/UCI HAR Dataset/test")
...
setwd("C:/Users/Lenovo/Documents/DataWeek4/UCI HAR Dataset/train")
